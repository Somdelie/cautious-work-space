...
export const BuildingIcon: React.FC<IconProps> = ({ className = "" }) => (
  <img src="/icons/suppliers.svg" alt="icon" width={34} height={24} />
);

// Package Icon for Products
export const PackageIcon: React.FC<IconProps> = ({ className = "" }) => (
  <img src="/icons/package.svg" alt="icon" width={34} height={24} />
);

// Users Icon for Managers
export const UsersIcon: React.FC<IconProps> = ({ className = "" }) => (
  <img src="/icons/users.svg" alt="icon" width={34} height={24} />
);
