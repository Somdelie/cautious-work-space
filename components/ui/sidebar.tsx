    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper has-data-[variant=inset]:bg-gray-800 flex min-h-svh w-full",
            className,
          )}
          {...props}
        >
    ...
    >
      ...
      >
        <div
          ...
          className="dark:bg-gray-900 group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm"
        >
          {children}
        </div>
      </div>
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "[[data-side=right][data-collapsible=offcanvas]_&]:-left-2 text-white",
        className,
      )}
      {...props}
    />
